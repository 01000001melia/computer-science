...
| :--- | :---: | :---: | :--- |
| [Introduction to Computer Science and Programming using Python](coursepages/intro-cs/README.md) | ✅ *Completed (MITx)* | ✅ *CS50 - Completed 2024 (HarvardX - Independent Study)* | Algorithmic thinking, Python programming, computational concepts • [Notes](notes/CS50's-CS) |
